(function () {
  ...
  // --- настройки и ссылки (оставляем без изменений) ---
  ...
  function renderPrices() {
    ...
    // Запускаем проверку по скроллу
    initScrollReveal();
  }

  // --- НОВЫЙ МЕТОД: проверка по скроллу ---
  ...
  function initScrollReveal() {
    ...
    // Если уменьшение движения – сразу показываем всё
    if (prefersReduced) {
    ...
    function checkVisibility() {
      ...
      var margin = 0.35; // 35% от высоты экрана (как в твоём старом коде)
    ...
    // Проверяем при скролле (с небольшим throttle)
    var ticking = false;
